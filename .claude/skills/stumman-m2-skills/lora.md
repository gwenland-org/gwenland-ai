...
> **Applies to:** `stumman/src/nn/adapter/` (implemented: `lora.rs`; stubs:
> `dora.rs`, `qlora.rs`, `loha.rs`, `vera.rs`, `locon.rs`)
> **Status:** `LRLora` is **landed and tested** (153/153 tests pass in
> `stumman/`, including numerical anchors against hand-computed values). This
> skill covers both maintaining it and extending the other five.
> **Prerequisite reading:** `stumman/M2_RESEARCH.md` §2, §7-A — the full
> per-paper research this skill distills.
> **Last updated:** 2026-08-17

## BEFORE YOU START

- [ ] I have read `stumman/src/nn/adapter/mod.rs`'s module doc comment — it
...
- [ ] I have read `stumman/src/nn/linear.rs`'s module doc comment for the
...
- [ ] If touching `LRLora` itself: I have run
      `cargo test --lib -p stumman adapter::lora` and it is green before I
      start.
...
- [../stumman-naming/SKILL.md](../stumman-naming/SKILL.md) — the `LR` prefix and full M2 name map
