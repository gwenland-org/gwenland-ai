...
Those are M2 and later. See [GLTRAIN_PLAN.md](GLTRAIN_PLAN.md) for where this
is going, and [KNOWN_ISSUES.md](KNOWN_ISSUES.md) for the constraints that are
deliberate rather than missing.

A note on platforms: gltrain builds on x86-64 Linux and Windows. It does not
...
commit later. See `gl-agent-skills/gltrain-naming/SKILL.md`. This document uses
...
use gltrain::{GlProc, Tape, Tensor};
...
[GLTRAIN_PLAN.md](GLTRAIN_PLAN.md), Milestone 2.
