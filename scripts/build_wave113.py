"""Build the repaired self-contained Wave 113 three-arm T4 Q8 head-to-head notebook."""
...
OUTPUT = ROOT / "notebooks/glcuda_t4_wave113_h2h_q8.ipynb"
...
bootstrap = bootstrap.replace("Wave 111", "Wave 113").replace("WAVE111", "WAVE113")
bootstrap = bootstrap.replace("wave111", "wave113")
bootstrap = bootstrap.replace(
    "glcuda-t4-wave113-residual-fusion-results.zip",
    "glcuda-t4-wave113-h2h-q8-results.zip",
)
...
model = model.replace("Wave57-Q8-H2H", "Wave113-Q8-H2H")
...
llama_build = llama_build.replace("WORK", "ROOT").replace("wave57", "wave113")
...
tokenizer = old_prod[tokenizer_start:tokenizer_end].replace("wave57", "wave113")
...
notebook = {
    "cells": [
        md("# GwenLand glcuda Wave 113 — repaired Q8 head-to-head on Tesla T4\n\n"
